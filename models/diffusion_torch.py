...
from models.diffusion_utils_torch import variance_preserving_map, alpha, sigma2
from models.diffusion_utils_torch import (
    NoiseScheduleScalar,
    NoiseScheduleFixedLinear,
    NoiseScheduleNet,
)
from models.scores_torch import (
    TransformerScoreNet,
    GraphScoreNet,
)
from models.mlp_torch import MLPEncoder, MLPDecoder
from datasets import load_data
import torch.distrbutions as dist
...
class VariationalDiffusionModel(nn.Module):
    ...
    def decode(
        ...
        if self.use_encdec:
            ...
            return dist.normal.Normal(loc=z0, scale=self.noise_scale)
